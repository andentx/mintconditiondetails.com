    ...
    <div className="relative mx-auto mb-20 max-w-screen-2xl">
      <div aria-hidden="true" className="absolute inset-0 flex justify-center overflow-hidden px-4">
        <Image
          ...
          className="h-full w-full max-w-screen-2xl rounded-lg border border-gray-800 object-cover object-center"
          height="1200"
          width="1600"
        />
      </div>
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pb-44 pt-24 text-center sm:pb-60 lg:pb-96 1280px:pb-[32rem]">
        <h1 className="mb-4 w-full max-w-xs rounded-lg border border-gray-800 bg-white/80 py-4 text-xl backdrop-blur-sm sm:max-w-lg sm:text-4xl md:max-w-2xl md:text-5xl lg:mb-12 lg:max-w-3xl lg:text-6xl">
        ...
        <p className="mb-12 w-full max-w-xs rounded-lg border border-gray-800 bg-white/80 px-6 py-4 text-base text-black backdrop-blur-sm sm:max-w-lg sm:text-lg lg:text-xl ">
